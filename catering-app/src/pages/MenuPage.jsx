        ...
        {activeTab === 'packed' && (
          <>
            <div className="bg-emerald-50 rounded-2xl p-6 mb-8">
              ...
              <p className="text-sm text-emerald-600 mt-2">Includes tetra pack juice or bottled water • Add ₱60/pack for canned soda</p>
            </div>
        ...
        {activeTab === 'snacks' && (
          <>
            <div className="bg-amber-50 rounded-2xl p-6 mb-8">
              ...
              <p className="text-sm text-amber-600 mt-2">Includes bottled water or tetra pack juice</p>
            </div>
