        ...
        {activeTab === 'packed' && (
          <>
            <div className="bg-emerald-50 rounded-2xl p-6 mb-8">
              ...
              <p className="text-sm text-emerald-600 mt-2">Minimum 10 packs • Includes juice/water • +₱60 for soda</p>
            </div>
        ...
        {activeTab === 'snacks' && (
          <>
            <div className="bg-amber-50 rounded-2xl p-6 mb-8">
              ...
              <p className="text-sm text-amber-600 mt-2">Minimum 10 packs • Includes juice/water</p>
            </div>
